...
if(!["791610073032949780"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
const muterol = message.guild.roles.cache.find(r => r.id === 'Cezalı')//Muteli rolü
