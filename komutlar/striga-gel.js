...
return message.reply(`Lütfen bu komutu kullanmadan önce bir ses kanalına giriş yap.`);
}
...
if (!member.voice.channel) return message.channel.send(`Bu kullanıcı bir ses kanalında bulunmuyor`).then(m => m.delete,{timeout: 5000});
